...
export const DAGGERHEART_SUBCLASSES: SubclassData[] = [
  // Bard Foundations
  {
    ...
    parentClass: "Bard",
    description:
      "Play the Troubadour if you want to support and inspire your allies.",
    features: [
      {
        name: "Virtuoso's Control",
        description:
          "After you succeed on an action roll using a musical instrument, mark a Hope.",
        level: 1,
      },
      {
        name: "Replenishing Song",
        description:
          "During a rest, spend a Hope to describe an inspiring performance. When you do, you and any allies who witnessed it clear an additional Stress, or a PC who witnessed it can clear a Hit Point.",
        level: 1,
      },
      {
        name: "Rousing Anthem",
        description:
          "When you succeed on an action with an Experience related to your performance, all PCs who can hear you can clear a Stress.",
        level: 3,
      },
      {
        name: "Song of Hope",
        description:
          "Once per long rest, mark a Stress to play a song and give every PC in your party who hears it a Hope.",
        level: 5,
      },
    ],
  },
  {
    ...
    parentClass: "Bard",
    description:
      "Play the Wordsmith if you want to use the power of your words to confuse and harm.",
    features: [
      {
        name: "Sharp Tongue",
        description:
          "Once per scene on an Instinct Roll, you can have your words cut someone down to size. Spend a Hope to make this roll at advantage and add your proficiency.",
        level: 1,
      },
      {
        name: "Sow Doubt",
        description:
          "Once per long rest, when you critically succeed on a Presence roll against an adversary within Close range, the GM tells you their greatest fear. You can spend 2 Hope to temporarily make the target Vulnerable.",
        level: 1,
      },
      {
        name: "Confusion",
        description:
          "You can make a Spellcast Roll against an adversary within Close range. On a success, the target cannot tell the difference between their allies and their enemies and will lash out at the closest creature to them on their next turn.",
        level: 3,
      },
      {
        name: "Deadly Vulgarity",
        description:
          "Once per long rest, when you deal damage with your words to an adversary, double the result.",
        level: 5,
      },
    ],
  },
  ...
  // Druid Foundations
  {
    ...
    parentClass: "Druid",
    description:
      "Play the Warden of the Elements if you want to command and shape the natural world.",
    features: [
      {
        name: "Nature's Wrath",
        description:
          "When you make a Spellcast Roll and deal damage with the spell, you can add your proficiency to the damage. When you do, mark a Stress.",
        level: 1,
      },
      {
        name: "Elemental Surge",
        description:
          "Whenever you mark your last Stress, describe how your magic goes momentarily out of control as you are overwhelmed with elemental energy.",
        level: 1,
      },
      {
        name: "Unleash the Elements",
        description:
          "When you use your Elemental Surge feature, spend a Hope to target all Close adversaries. Make a Spellcast Roll against each, dealing 2d10 magic damage on a success.",
        level: 3,
      },
      {
        name: "Master of Elements",
        description:
          "Once per session, when you channel elemental energy, clear all of your marked Stress.",
        level: 5,
      },
    ],
  },
  {
    ...
    parentClass: "Druid",
    description:
      "Play the Warden of Renewal if you want to shape-shift and support your allies.",
    features: [
      {
        name: "Beastform",
        description:
          "Mark a Stress to take on a Beastform. Choose a trait to specialize in while in this form, and take +2 on rolls with it.",
        level: 1,
      },
      {
        name: "Rejuvenating Touch",
        description:
          "Spend a Hope to describe how you use natural materials or magic to help an ally, then clear a Hit Point on them.",
        level: 1,
      },
      {
        name: "Lick Your Wounds",
        description:
          "Once per short rest, while in Beastform, spend a Hope to clear 2 Hit Points on yourself.",
        level: 3,
      },
      {
        name: "Nature's Gift",
        description:
          "Once per long rest, spend a Hope during a rest to allow all PCs to clear 2 Stress and 2 Hit Points.",
        level: 5,
      },
    ],
  },
  ...
  // Guardian Foundations
  {
    ...
    description:
      "Play the Stalwart if you want to protect others and be the shield that guards them from harm.",
    features: [
      {
        name: "Protector",
        description:
          "When an ally within Very Close range of you is attacked, spend your reaction to move into the path of danger. You become the new target of the attack and take +1 to your Evasion against it.",
        level: 1,
      },
      {
        name: "Shield Bash",
        description:
          "Make a Finesse attack using a shield. On a success, temporarily make the target Vulnerable.",
        level: 1,
      },
      {
        name: "Protective Taunt",
        description:
          "Once per short rest, you can mark 2 Stress to force all adversaries within Very Close range to attack you (if possible) until your next turn.",
        level: 3,
      },
      {
        name: "Immovable Object",
        description:
          "When you would become Vulnerable, Restrained, or Stunned, spend 2 armor slots to ignore the effect.",
        level: 5,
      },
    ],
  },
  {
    ...
    parentClass: "Guardian",
    description:
      "Play Vengeance if you want to punish those who harm your allies and serve justice.",
    features: [
      {
        name: "Retribution",
        description:
          "Mark Vendetta on an adversary that damages you or an ally. Take +1 to damage against an adversary you've marked with Vendetta.",
        level: 1,
      },
      {
        name: "Relentless",
        description:
          "Mark a Stress when moving into Close range of an adversary marked with Vendetta to also make a weapon attack against them.",
        level: 1,
      },
      {
        name: "Share the Pain",
        description:
          "When you take damage from an adversary marked with Vendetta, you can mark a Stress to deal 1d6 damage to them.",
        level: 3,
      },
      {
        name: "Never Forgive",
        description:
          "Your Vendetta damage bonus increases to +3. Once per scene, when you defeat an adversary marked with Vendetta, describe your victory and mark Vendetta on another adversary.",
        level: 5,
      },
    ],
  },
  ...
  },
  {
    ...
    parentClass: "Ranger",
    description:
      "Play the Wayfinder if you want to guide your party and track your prey.",
    features: [
      {
        name: "Tracker",
        description:
          "When you spend a Hope to track a creature, you know exactly where it went. The GM will describe its path and current location.",
        level: 1,
      },
      {
        name: "Ranger's Focus",
        description:
          "Mark a Stress to study a creature and mark your Focus on it. Against this target, always succeed on attacks with Hope.",
        level: 1,
      },
      {
        name: "Hunter's Mark",
        description:
          "You can mark Focus on a number of creatures equal to your proficiency tier.",
        level: 3,
      },
      {
        name: "Never Lose the Trail",
        description:
          "You can sense the exact location of any creature you've marked with Focus within ten miles. Once per long rest, you can teleport to appear within Close range of a marked creature.",
        level: 5,
      },
    ],
  },
  ...
  // Selected additional foundations...
  {
    ...
    parentClass: "Rogue",
    description:
      "Play the Nightwalker if you want to become one with the shadows.",
    features: [
      {
        name: "Shadow",
        description:
          "When you are hidden and concealed within darkness, enemies must roll with disadvantage to find you.",
        level: 1,
      },
      {
        name: "Cheap Shot",
        description:
          "If you're hidden from your target before an attack, mark a Stress to add an extra damage die to the roll.",
        level: 1,
      },
      {
        name: "Smoke Bomb",
        description:
          "Once per short rest, spend a Hope to throw a smoke bomb that creates concealment in a Close area for the scene.",
        level: 3,
      },
      {
        name: "Master of Shadows",
        description:
          "Once per long rest, become invisible for one minute or until you attack or cast a spell.",
        level: 5,
      },
    ],
  },
